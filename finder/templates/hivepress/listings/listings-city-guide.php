...
<div class="finder-listings-wrap">
	<?php
		/**
		 * Functions hooked in to finder_listings_city_guide_loop_before action
		 *
		 ...
		 */
		do_action( 'finder_listings_city_guide_loop_before' );

		/**
		 * Functions hooked in to finder_listings_city_guide_loop action
		 *
		 * @hooked finder_hivepress_listings_city_guide_loop_content - 10
		 */
		do_action( 'finder_listings_city_guide_loop' );

		/**
		 * Functions hooked in to finder_listings_city_guide_loop_after action
		 *
		 ...
		 */
		do_action( 'finder_listings_city_guide_loop_after' );
	?>
</div>
