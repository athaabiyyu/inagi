	...
	<div class="finder-hp-listing-images tns-carousel-wrapper card-img-top card-img-hover">
		...
		<div class="tns-carousel-inner">
			<?php if ( $listing_images ) : ?>
				...
				<?php endforeach; ?>
			<?php else : ?>
					<img class="w-100" src="<?php echo esc_url( hivepress()->get_url() . '/assets/images/placeholders/image-landscape.svg' ); ?>" alt="<?php echo esc_attr( $listing->get_title() ); ?>" loading="lazy">
			<?php endif; ?>
		</div>
	</div>
	<div class="card-body">
