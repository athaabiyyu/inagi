<?php
/**
 * Loop posts template for Real Estate.
 *
...
<article class="col pb-2 pb-md-1 position-relative">
	<?php if ( 'yes' === $badge ) : ?>
		<span class="badge bg-info position-absolute top-0 end-0 m-3 me-4 zindex-1 fs-sm"><?php echo esc_html__( 'New', 'finder' ); ?></span>
	<?php endif; ?>	
	<?php if ( has_post_thumbnail() ) : ?>
	<div class="aspect-ratio aspect-w-54 aspect-h-25 mb-3">
	...
	<?php the_title( sprintf( '<h3 class="h5 mb-2 pt-1"><a href="%s" class="nav-link stretched-link" rel="bookmark">', esc_url( get_permalink() ) ), '</a></h3>' ); ?>
